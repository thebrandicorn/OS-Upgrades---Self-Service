...
MSG="Your Mojave upgrade will start in the next 15 minutes. Please save any work and click \"Ok\"."
...
sudo /Library/Application\ Support/JAMF/bin/jamfHelper.app/Contents/MacOS/jamfHelper -windowType fs -title "Test" -heading "Upgrade in Progress" -description "Your MacOS Upgrade has started. Your computer will reboot soon" -icon /Applications/Install\ macOS\ Mojave.app/Contents/Resources/InstallAssistant.icns >/dev/null 2>&1 &

#Starts the upgrade
/Applications/Install\ macOS\ Mojave.app/Contents/Resources/startosinstall --agreetolicense --nointeraction --rebootdelay 45
